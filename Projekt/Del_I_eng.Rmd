...
In this first task you should code a number of functions in R. They should be coded in an external script file `funktioner.R`, rather than  within your R-Markdown document. This makes them easily re-used in forthcoming tasks. In R-Markdown you then write
