...
In the project you will be working with data from the Swedish Transport Admnistration consisting of the driving part of the test for obtaining a Swedish driving licence, performed in Sollantuna during 2014. Data is available for all individuals under the age of 50 taking the test, but you will only use a random sample of 1000 individuals. For each individual, you have access to explanatory variables *sex*, *age* and *educator* (whether the individual trained privately ("Privatist") or in a driving school ("Trafikskola")) and the result of the test (`TRUE` for success).
